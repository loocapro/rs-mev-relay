/// https://github.com/sigp/lighthouse/blob/dcd69dfc628cad5998225d5100b222458f3f0ecb/crypto/bls/src/macros.rs
...
macro_rules! impl_from_str {
    () => {
        ...
        fn from_str(s: &str) -> Result<Self, Self::Err> {
            let bytes = serde_utils::hex::decode(s).map_err(|e| e.to_string())?;
